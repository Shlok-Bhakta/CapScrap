module Admin::DashboardHelper
  def sort_user_header(field, display_name, current_sort, current_direction)
  ...
  def sort_items_header(field, display_name, current_sort, current_direction)
    next_direction = if current_sort != field
      "asc"  # First click on a new column
    elsif current_direction == "asc"
          "desc" # Switch to descending
    ...
    link_to admin_dashboard_items_path(path_params),
           class: link_class,
  ...
  def sort_purchases_header(field, display_name, current_sort, current_direction)
    next_direction = if current_sort != field
      "asc"  # First click on a new column
    elsif current_direction == "asc"
          "desc" # Switch to descending
    ...
    link_to admin_dashboard_purchased_path(path_params),
           class: link_class,
  ...
  def sort_rentings_header(field, display_name, current_sort, current_direction)
    next_direction = if current_sort != field
      "asc"  # First click on a new column
    elsif current_direction == "asc"
          "desc" # Switch to descending
